...
class StudentsPolicy
{
    ...
    {
        return $user->can('view_any_students');
    }
    ...
    {
        return $user->can('delete_any_students');
    }
    ...
    {
        return $user->can('force_delete_students');
    }
    ...
    {
        return $user->can('force_delete_any_students');
    }
    ...
    {
        return $user->can('restore_students');
    }
    ...
    {
        return $user->can('restore_any_students');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Students $students): bool
    {
        return $user->can('replicate_students');
    }
    ...
    {
        return $user->can('reorder_students');
    }
}
